...
## Client side renderer implement

Now with less network cost! less than 13KB! wow!
Also comes with a custom chart loader

## Bugged Chart

Rift Within does not contain vibe data
Some charts in Newest dlc (celeste) does not contain bpm or necessary values.
